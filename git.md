...
**git branch -a** - посмотреть список веток в том числе в клонированном репозитарии.
...
**git reset HEAD `Название измененного файла`** - сброс проиндексируемого файла, отчистка буферной зоны от изменений. После необходимо сделать _checkout `измененный файл`_ для переключения на версию коммита до изменений.
...
**git mv `имя файла` `папка`** - перемещение файла в укзанное место.